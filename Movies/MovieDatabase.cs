...
namespace Movies
{
    ...
    public static class MovieDatabase
    {
        ...
        /// <summary>
        /// Filters the provided collection of movies to those with Rotten Tomatoe Ratings within given parameters
        /// </summary>
        /// <param name="movies">the collection of movies to filter</param>
        /// <param name="min">the minimum parameter</param>
        /// <param name="max">the maximum parameter</param>
        /// <returns></returns>
